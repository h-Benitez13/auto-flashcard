...
async fn main() -> anyhow::Result<()> {
    ...
    let app = Router::new()
        ...
        .route("/documents/:id", get(handlers::get_document).patch(handlers::rename_document).delete(handlers::soft_delete_document))
        .route("/documents/:id/restore", post(handlers::restore_document))
